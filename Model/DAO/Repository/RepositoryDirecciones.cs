    ...
    public class RepositoryDirecciones : IRepositoryDirecciones
    {
                 ...
                 && respuestaBD.Data.Tables[0].Rows.Count > 0)
                {
                    ...
                    foreach (DataRow fila in respuestaBD.Data.Tables[0].Rows)
                    {
                        DireccionEntidad aux = new DireccionEntidad
                        {
                            ...
                            Numero_Ext = (int)fila["numero_ext"],
                            Numero_Int = (int)fila["numero_int"],
                            CP = fila["cp"].ToString(),
                            Entre_Calles = fila["entre_calles"].ToString(),
            ...
            if (!respuestaBD.ExisteError)
            {
                ...
                && respuestaBD.Data.Tables[0].Rows.Count > 0)
                {
                    DireccionEntidad aux = new DireccionEntidad
                    {
                        ...
                        Numero_Ext = (int)respuestaBD.Data.Tables[0].Rows[0]["numero_ext"],
                        Numero_Int = (int)respuestaBD.Data.Tables[0].Rows[0]["numero_int"],
        ...
        public async Task<DireccionEntidad> CreateAsync(DireccionEntidad direccion)
        {
            ...
            Task<RespuestaBD> respuestaBDTask = _sqlTools.ExecuteFunctionAsync(
                ...
                new ParameterPGsql("p_numero_ext", NpgsqlTypes.NpgsqlDbType.Integer, direccion.Numero_Ext),
                new ParameterPGsql("p_numero_int", NpgsqlTypes.NpgsqlDbType.Integer, direccion.Numero_Int),
                new ParameterPGsql("p_cp", NpgsqlTypes.NpgsqlDbType.Varchar, direccion.CP),
                new ParameterPGsql("p_entre_calles", NpgsqlTypes.NpgsqlDbType.Varchar, direccion.Entre_Calles),
                new ParameterPGsql("p_descripcion", NpgsqlTypes.NpgsqlDbType.Varchar, direccion.Descripcion),
            ...
            if (!respuestaBD.ExisteError)
            {
                DireccionEntidad aux = new DireccionEntidad
                {
                    ...
                    Numero_Int = (int)respuestaBD.Data.Tables[0].Rows[0]["numero_int"],
                    CP = respuestaBD.Data.Tables[0].Rows[0]["cp"].ToString(),
                    Entre_Calles = respuestaBD.Data.Tables[0].Rows[0]["entre_calles"].ToString(),
                    Descripcion = respuestaBD.Data.Tables[0].Rows[0]["descripcion"].ToString(),
                    Activo = respuestaBD.Data.Tables[0].Rows[0]["activo"] as bool?,
                    Fecha_modificacion = respuestaBD.Data.Tables[0].Rows[0]["fecha_modificacion"] as DateTime?,
                    Fecha_creacion = respuestaBD.Data.Tables[0].Rows[0]["fecha_creacion"] as DateTime?
